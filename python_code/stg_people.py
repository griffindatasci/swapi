...
command = """INSERT INTO stg_people (name, birth_year, eye_color, gender, hair_color, height, mass, skin_color, homeworld, url, created, edited) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"""
...
with psycopg2.connect(database=database_name, 
    ...
    for person in people:
        cursor.execute(command, tuple([person["name"], 
                                       person["birth_year"], 
                                       person["eye_color"], 
                                       person["gender"], 
                                       person["hair_color"], 
